      ...
      iframe: {
        ...
        patterns: {
          youtube: {
            index: "youtube.com/",
            id: "v=",
            src: "https://www.youtube.com/embed/B9ESnjes-VI",
          },
        },
      },
      // other options
      ...
      iframe: {
        ...
        patterns: {
          youtube: {
            index: "youtube.com/",
            id: "v=",
            src: "https://www.youtube.com/embed/BzPGlPjfMvg",
          },
        },
      },
      // other options
...
class I18n {
  constructor(defaultLang = "en") {
    this.translations = {};
    this.lang = localStorage.getItem("siteLang") || defaultLang;
  ...
  async loadLang(lang) {
    ...
    this.applyTranslations(this.translations[lang], lang);
  }

  applyTranslations(dict, lang) {
    document.querySelectorAll("[data-i18n]").forEach((el) => {
      const keys = el.getAttribute("data-i18n").split(".");
      let val = keys.reduce((obj, k) => obj && obj[k], dict);
      if (val) el.textContent = val;
    });

    // edit language & dir
    // document.getElementById("page").dir = lang === "ar" ? "rtl" : "ltr";
    ...
    if (lang === "ar") {
      page.classList.add("rtl");
    } else {
      page.classList.remove("rtl");
    }
  }
...
// init nice select
$(document).ready(function () {
  $("#langSwitch").niceSelect();

  // set default value
  $("#langSwitch").val(i18n.lang).niceSelect("update");
